...
function getRandomHexValue() {
    ...
    // random hex value akan mengembalikan hanya 1 value sesuai yang ada di variable hexValue
}

function getRandomHexString(stringLength) {
    let hexString = '';
    // disini getRandomHexValue akan dilooping sebanyak nilai yang diinput
